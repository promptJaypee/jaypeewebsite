...
import testimonials from "@/app/data/jsons/testimonials.json";
...
export default function Home() {
  ...
  const goToTestimonial = (index: number) => {
    setTestimonialIndex(
      ((index % testimonialTotal) + testimonialTotal) % testimonialTotal,
    );
  };
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      setTestimonialIndex((prev) => (prev + 1) % testimonialTotal);
    }, 5000);
    return () => clearInterval(interval);
  }, [isTestimonialPaused, testimonialTotal]);
  ...
  return (
    <div>
      ...
      <main className="w-full min-h-screen bg-gray-50 dark:bg-linear-to-br dark:from-gray-900 dark:via-black dark:to-gray-900 pt-12">
        ...
        <section
          id="testimonials"
          className="w-full py-20 px-6 lg:px-20 bg-gray-50 dark:bg-linear-to-br dark:from-black dark:via-gray-900 dark:to-black scroll-mt-24"
        >
          <div className="max-w-5xl mx-auto">
            <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-4 text-center bg-linear-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent">
              Testimonials
            </h2>
            <p className="text-gray-600 dark:text-gray-400 text-center text-base sm:text-lg mb-16">
            ...
            >
                ...
                >
                  {testimonials.map((t, index) => (
                    <div key={index} className="w-full flex-shrink-0 px-2">
                      <div className="group relative bg-gray-50 dark:bg-linear-to-br dark:from-gray-800 dark:to-gray-900 rounded-lg overflow-hidden border border-blue-300 dark:border-blue-500 dark:border-opacity-30 hover:border-blue-400 dark:hover:border-cyan-400 transition duration-300 hover:shadow-2xl hover:shadow-blue-500/50 dark:hover:shadow-blue-500/50 p-8 sm:p-10">
                        <div className="absolute inset-0 bg-linear-to-r from-blue-500 to-cyan-500 opacity-0 group-hover:opacity-10 transition duration-300" />
                        <div className="relative z-10 flex flex-col items-center text-center">
                          ...
                          <p className="text-gray-700 dark:text-gray-300 text-lg leading-relaxed mb-6 max-w-2xl">
                            &ldquo;{t.quote}&rdquo;
                          </p>
                          ...
                          <div className="flex items-center gap-4">
                            {t.avatar ? (
                              ...
                              <div className="w-12 h-12 rounded-full bg-linear-to-r from-blue-500 to-cyan-500 flex items-center justify-center text-white font-semibold">
                                {t.name
                                  .split(" ")
                                  .map((n) => n[0])
                                  .join("")}
              ...
              <button
                ...
                className="hidden sm:flex absolute top-1/2 -left-4 -translate-y-1/2 w-10 h-10 items-center justify-center rounded-full bg-white dark:bg-gray-800 border border-blue-300 dark:border-blue-500 dark:border-opacity-30 text-blue-600 dark:text-blue-400 hover:scale-110 hover:shadow-lg hover:shadow-blue-500/50 transition"
              >
                ‹
              </button>
              <button
                ...
                className="hidden sm:flex absolute top-1/2 -right-4 -translate-y-1/2 w-10 h-10 items-center justify-center rounded-full bg-white dark:bg-gray-800 border border-blue-300 dark:border-blue-500 dark:border-opacity-30 text-blue-600 dark:text-blue-400 hover:scale-110 hover:shadow-lg hover:shadow-blue-500/50 transition"
              >
                ›
              </button>
                  ...
                  <button
                    ...
                    className={`h-2 rounded-full transition-all duration-300 ${
                      index === testimonialIndex
                        ? "w-6 bg-linear-to-r from-blue-500 to-cyan-500"
